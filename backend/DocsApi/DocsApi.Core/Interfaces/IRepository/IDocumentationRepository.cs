...
public interface IDocumentationRepository
{
    ...
    Task<List<Documentation>> GetAllDocumentationsLightweightAsync();
    Task<List<int>> GetProjectsWithDocumentationAsync();
    Task<List<Documentation>> GetLatestVersionPerProjectAsync();
    ...
    Task<bool> VersionExistsAsync(int projectId, string version, bool isTest);
